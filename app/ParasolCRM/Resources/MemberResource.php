...
use App\ParasolCRM\Filters\MemberClubsFilter;
    ...
    public function filters(): array
    {
        return [
            LikeFilter::make(TextFilterField::make(), 'members.member_id', null, 'Member id')
                ->quick(),
            LikeFilter::make(TextFilterField::make(), 'first_name', 'members.first_name')
                ->quick(),
            LikeFilter::make(TextFilterField::make(), 'last_name', 'members.last_name')
                ->quick(),
            InFilter::make(
            ...
            LikeFilter::make(TextFilterField::make(), 'phone', 'members.phone'),
            InFilter::make(
                MultipleSelectFilterField::make()
