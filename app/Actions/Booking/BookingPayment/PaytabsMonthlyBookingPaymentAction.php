...
class PaytabsMonthlyBookingPaymentAction extends BaseBookingPaymentAction
{
    public function handle(array $params): ?string
    {
        return Cache::remember('paytabs_monthly_url_booking_'.$this->booking->id, now()->addMinutes(19), function () {
