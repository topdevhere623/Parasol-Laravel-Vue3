...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    var moment = (typeof window != 'undefined' && typeof window.moment != 'undefined') ? window.moment : require(
      'moment')
  ...
  DateRangePicker.prototype = {
    ...
    renderTimePicker: function (side) {
      ...
      if (!this.timePicker24Hour) {
        ...
        if (selected.hour() >= 12) {
          html += '<option value="AM"' + am_html + '>AM</option><option value="PM" selected="selected"' + pm_html +
            '>PM</option>'
        }
        else {
          html += '<option value="AM" selected="selected"' + am_html + '>AM</option><option value="PM"' + pm_html +
            '>PM</option>'
        }
    ...
    clickApply: function (e) {
      this.hide()
      this.element.val(this.startDate.format('DD MMMM YYYY'))
      this.element.next().val(this.startDate.format('YYYY-MM-DD'))
    ...
    timeChanged: function (e) {
      ...
      if (isLeft) {
        ...
        else if (this.endDate && this.endDate.format('YYYY-MM-DD') == start.format('YYYY-MM-DD') &&
